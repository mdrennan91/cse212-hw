public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Fixed: Enqueue now adds to the end of the queue, and Dequeue removes from the front.
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Fixed: Items are dequeued in the correct order.
        ...
        // Defect(s) Fixed: Proper exception handling when the queue is empty.
    }
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Fixed: Add to the end of the queue
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; // Fixed: Remove from the front of the queue
        _queue.RemoveAt(0);
        return value;
    }
}